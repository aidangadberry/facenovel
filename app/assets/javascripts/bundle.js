...
/******/ 	return __webpack_require__(__webpack_require__.s = "./frontend/facenovel.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
var signup = exports.signup = function signup(user) {
  return dispatch(ApiUtil.signup(user).then(function (res) {
    return dispatch(receiveCurrentUser(res));
  }));
};
...
var _users_reducer = __webpack_require__(/*! ./users_reducer */ "./frontend/reducers/users_reducer.js");
...
var _session_errors_reducer = __webpack_require__(/*! ./session_errors_reducer */ "./frontend/reducers/session_errors_reducer.js");
...
var _session_reducer = __webpack_require__(/*! ./session_reducer */ "./frontend/reducers/session_reducer.js");
...
var usersReducer = function usersReducer() {
  ...
  switch (action.type) {
    case _session_actions.RECEIVE_CURRENT_USER:
      return Object.assign(newState, _defineProperty({}, action.currentUser.id, action.currentUser));
    default:
      return state;
  }
};
